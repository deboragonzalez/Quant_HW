...
== Equal to – checks if two values are exactly equal. != Not equal to – checks if two values are different.
...
```{r, echo = TRUE}
!(7 > 6) & (7==7) | (6==5)
# First statement is FALSE bc it's the negation of the TRUE statement in parenthesis.
# Second statement is TRUE
# Third statement is FALSE
# AND before OR gives us FALSE & TRUE, which is FALSE.
# OR statement is then FALSE.
...
Hierarchy: AND before OR according to swirl.
...
# Playing with my function. Giving it a vector of values and testing it.
...
# Taking my remainder function from swirl lesson:
